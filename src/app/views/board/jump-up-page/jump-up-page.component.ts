...
@Component({
  selector: 'app-jump-up-page',
  templateUrl: 'jump-up-page.component.html',
  styleUrls: ['./jump-up-page.component.scss']
})
export class JumpUpPageComponent implements OnInit {
  ...
  async ngOnInit() {
    this.titleService.setTitle('Jump-up page');
