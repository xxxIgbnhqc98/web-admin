...
@Component({
  selector: 'app-setting-user-permission-list',
  templateUrl: 'setting-user-permission-list.component.html',
  styleUrls: ['./setting-user-permission-list.component.scss']
})
export class SettingUserPermissionListComponent implements OnInit {
  ...
  async editValue(form: NgForm) {
    try {
      ...
      await this.apiService.settingUserPermission.update(this.id_update, {
        value: this.value
      });
